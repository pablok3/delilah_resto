...
const { checkForOrderPending, checkFields, createNewOrder, modifyOrder, deleteOrder, confirmOrder, changeOrderState, checkOrderStatusInput } = require('./middleware');
...
router.patch('/:orderId', IsUserLogged, IsUserAdmin, checkOrderStatusInput, changeOrderState, (req, res) => {
    res.status(201).json(
        {
